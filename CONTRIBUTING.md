...
`git clone https://github.com/Conrage/ticTacToe.git`
...
Você pode criar uma issue [aqui](https://github.com/Conrage/ticTacToe/issues), mas, lembre-se de ser claro e informar o máximo de detalhes possíveis.
